...
namespace IIS.AZSKursach
{
    ...
    [View("ЗаправкаАвтоE", new string[] {
            ...
            "ЗаправБак as \'Тип топлива\'"})]
    [MasterViewDefineAttribute("ЗаправкаАвтоE", "ЗаправБак", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "ТипТопл")]
    ...
    public class ЗаправкаАвто : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AZSKursach.ЗаправБак fЗаправБак;
        ...
        [PropertyStorage(new string[] {
                "ЗаправБак"})]
        [NotNull()]
        public virtual IIS.AZSKursach.ЗаправБак ЗаправБак
        {
            get
            {
                ...
                IIS.AZSKursach.ЗаправБак result = this.fЗаправБак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаправкаАвтоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаправкаАвтоE", typeof(IIS.AZSKursach.ЗаправкаАвто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаправкаАвтоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаправкаАвтоL", typeof(IIS.AZSKursach.ЗаправкаАвто));
                }
            }
        }
    }
